...
Check any wallet&#x27;s Aave V3 position on Arbitrum. Health factor, collateral, debt, and risk status. Chains with ETH Price Feed for richer analysis.
...
curl -X POST http://localhost:3000/execute \
  ...
  -d '{"milkyway_version":"1.0","job_id":"test","task":{"capability":"check_position","input":{"query":"hello"}},"deadline":9999999999}'
```
